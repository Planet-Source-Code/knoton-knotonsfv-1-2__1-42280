...
Function Associate(AppTitle As String, FileExtension As String, FileType As String, Optional Parameters As String)
...
' This sets the icon for the file extension
   'If IconFileName <> "" Then
    sKeyName = AppTitle
    sKeyValue = App.path & "\" & App.EXEName & ".exe,0"  'IconFileName
    ret& = RegCreateKey&(HKEY_CLASSES_ROOT, sKeyName, lphKey&)
